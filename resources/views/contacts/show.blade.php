                        ...
                        <div class="container px-5 mx-auto">
                            ...
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <form method="get" action="{{ route('contacts.edit', ['id' => $contact->id]) }}"></form>
                                        <div class="p-2 w-full">
                                    ...
                                    <form method="post" action="{{ route('contacts.destroy', ['id' => $contact->id]) }}"></form>
                                        @csrf
                                        <div class="p-2 w-full">
                                            <a class="flex mx-auto text-white bg-pink-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">削除する</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
